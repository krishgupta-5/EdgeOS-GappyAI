import { ArrowRightIcon, ChevronRight, Sparkles } from "lucide-react";
        ...
        <div className="relative z-40 flex flex-col items-center w-full max-w-5xl mx-auto my-24 text-center">
            ...
            <Container delay={0.0}>
                ...
                <div className="pl-2 pr-1 py-1 rounded-full border border-foreground/10 hover:border-foreground/20 backdrop-blur-md cursor-pointer flex items-center gap-2.5 select-none w-max mx-auto transition-all duration-300 shadow-[0_0_20px_rgba(0,0,0,0.05)] dark:shadow-[0_0_20px_rgba(255,255,255,0.02)]">
                    ...
                    <span className="inline-flex items-center justify-center gap-2 font-medium tracking-tight bg-gradient-to-r from-[#b2a8fd] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-sm text-transparent animate-text-gradient">
                        ...
                        <span className="flex items-center justify-center px-2 py-0.5 text-[10px] uppercase font-bold tracking-wider rounded-full text-foreground/80 bg-foreground/5 border border-foreground/10">
                            New
                            <ArrowRightIcon className="w-3 h-3 ml-1 text-foreground/50" />
                        </span>
                    </span>
                </div>
            </Container>
            ...
            <Container delay={0.1}>
                <h1 className="max-w-4xl mx-auto mt-8 text-4xl font-bold tracking-tighter text-center md:text-6xl lg:text-7xl relative z-20 leading-[1.1]">
                    ...
                    <Cover>planning & execution</Cover>
                </h1>
            </Container>
            ...
            <Container delay={0.2}>
                <p className="max-w-2xl mx-auto mt-6 text-base leading-relaxed sm:text-lg lg:text-xl text-muted-foreground">
                    Generate <span className="font-medium text-foreground">roadmaps</span>,{" "}
                    <span className="font-medium text-foreground">architecture</span>,{" "}
                    <span className="font-medium text-foreground">APIs</span>,{" "}
                    <span className="font-medium text-foreground">database schemas</span>,{" "}
                    <span className="font-medium text-foreground">CI/CD pipelines</span>,{" "}
                    <span className="font-medium text-foreground">testing workflows</span> and complete{" "}
                    <span className="font-medium text-foreground">technical documentation</span> — all in one{" "}
                    <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-primary/15 text-primary border border-primary/20 font-medium whitespace-nowrap">
