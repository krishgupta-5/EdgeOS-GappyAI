...
const PLANS = [
    {
        id: "starter",
        title: "Starter",
        desc: "Perfect for founders, students and solo builders.",
        features: [
            "AI Product Planning",
            "Roadmap Generation",
            "User Stories",
    ...
    },
    {
        id: "pro",
        title: "Pro",
        desc: "For developers building production-ready software.",
        features: [
    ...
    },
    {
        id: "team",
        title: "Team",
        desc: "For startups and collaborative product teams.",
        features: [
            "Everything in Pro",
            "Team Workspaces",
        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24 w-full relative">
            <Container>
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
                    <SectionBadge title="Early Access" />
                    
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6 text-foreground">
                        Build better products with AI <span className="whitespace-nowrap">Free for now</span>
                    </h2>
                    
                    <p className="text-base md:text-lg text-center text-foreground/60 mt-6 leading-relaxed max-w-2xl">
                        Generate product roadmaps, technical documentation, APIs, database schemas, 
                        architecture plans and testing strategies completely free during our early access period.
                    </p>
                </div>
            </Container>
                    ...
                    <div className="p-3 h-auto flex w-full items-center relative z-20 mt-auto">
                        ...
                        >
                            <Link href="https://chat.krishgupta.dev/">
                                {isStarter ? "Start Planning Free" : "Upgrade"}
                            </Link>
                        </Button>
                    </div>
