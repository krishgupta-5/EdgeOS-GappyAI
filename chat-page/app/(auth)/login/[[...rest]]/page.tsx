...
// Structural, non-glowing network pattern
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at center, #000000 30%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 1,
        }}
      />
      ...
      >
        ...
        >
          <span style={{ color: "#444" }}>[SYS]</span> ~/edge-os/auth/login
        </div>
