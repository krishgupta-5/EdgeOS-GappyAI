...
type Tab = "profile" | "preferences" | "security" | "billing" | "integrations";
      ...
      <div style={{ width: "100%", maxWidth: "1024px", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <NavButton active={activeTab === "integrations"} onClick={() => setActiveTab("integrations")} label="Integrations" />
...
function IntegrationsSection() {
  ...
  return (
    <div style={{ animation: "slideFade 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards" }}>
      <SectionHeader title="Integrations" description="Connect Edge OS with your favorite third-party services." />
      ...
      <GlassCard>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div>
              <div style={{ fontSize: "16px", color: T.text, fontFamily: T.font, fontWeight: 500, marginBottom: "4px" }}>Notion</div>
              <div style={{ fontSize: "13px", color: T.textMuted, lineHeight: "1.6", fontFamily: T.font }}>
          ...
          {loading ? (
            <div style={{ color: T.textHint, fontSize: "13px", fontFamily: T.font }}>Loading...</div>
          ) : data?.connected ? (
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                onClick={() => window.location.href = "/api/notion/connect"}
                style={{
                  padding: "8px 16px", background: "transparent", border: `1px solid ${T.borderHover}`, color: T.text,
                  borderRadius: "8px", fontSize: "13px", fontFamily: T.font, fontWeight: 500, cursor: "pointer", transition: "all 0.2s ease",
                }}
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.3)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.borderColor = T.borderHover; }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px", fontSize: "13px", fontFamily: T.font, fontWeight: 500, cursor: disconnecting ? "not-allowed" : "pointer", transition: "all 0.2s ease", opacity: disconnecting ? 0.5 : 1
                }}
            ...
            <button
              onClick={() => window.location.href = "/api/notion/connect"}
              style={{
                padding: "8px 16px", background: T.text, border: "none", color: T.bg,
                borderRadius: "8px", fontSize: "13px", fontFamily: T.font, fontWeight: 600, cursor: "pointer", transition: "opacity 0.2s ease",
              }}
        ...
        {data?.connected && (
          <>
            <div style={{ height: "1px", width: "100%", background: T.border }} />
            <div>
              <div style={{ fontSize: "14px", color: T.text, fontFamily: T.font, fontWeight: 500, marginBottom: "16px" }}>Integration Settings</div>
              
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: "13px", color: T.textMuted, fontFamily: T.font }}>Connected Workspace</span>
                  <span style={{ fontSize: "13px", color: T.text, fontFamily: T.font, fontWeight: 500 }}>{data.workspaceName}</span>
                </div>

                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: "13px", color: T.textMuted, fontFamily: T.font }}>Default Parent Page</span>
                  <select
                    value={selectedPage}
                ...
                {!selectedPage && (
                  <div style={{ fontSize: "12px", color: "#f59e0b", fontFamily: T.font, marginTop: "-8px", textAlign: "right" }}>
